...
namespace Services
{
    ...
    #pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        ...
        {
            return System.Threading.Tasks.Task.Run(async () => await SubmitFoodAsync(amount, System.Threading.CancellationToken.None)).GetAwaiter().GetResult();
        }
        ...
        public virtual async System.Threading.Tasks.Task<SubmissionResult> SubmitFoodAsync(double? amount, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    // Operation Path: "submitFood"
                    urlBuilder_.Append("submitFood");
                    urlBuilder_.Append('?');
                    if (amount != null)
                    {
        ...
        {
            return System.Threading.Tasks.Task.Run(async () => await SubmitWaterAsync(amount, System.Threading.CancellationToken.None)).GetAwaiter().GetResult();
        }
        ...
        public virtual async System.Threading.Tasks.Task<SubmissionResult> SubmitWaterAsync(double? amount, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "submitWater"
                    urlBuilder_.Append("submitWater");
                    urlBuilder_.Append('?');
                    if (amount != null)
                    {
                        urlBuilder_.Append(System.Uri.EscapeDataString("amount")).Append('=').Append(System.Uri.EscapeDataString(ConvertToString(amount, System.Globalization.CultureInfo.InvariantCulture))).Append('&');
